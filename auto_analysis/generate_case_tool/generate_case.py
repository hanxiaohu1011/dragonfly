"""
*************************************
 Copyright 2019 Dell EMC Inc.
[Purpose]: half automate generate case
[Author ]: Heshi.wu@dell.com
[History]:
*************************************
"""
import os
...
from pub.Const import EUROPA, OBERON, HYPERION, LUNA, WARTHOG, BEACHCOMBERFC, \
    EUROPA1U, BANSHEE, WARNADO, WARNADOEX, RIPTIDE, BOLERO, ENTERPRISE, ENTRY,\
    FORNAXKEPLER, FORNAXKOSMOS
